...
static int get_digit(int number, int pos)
{
	int i;
...
static int inc_digit(int number, int pos)
{
	int term = 1;
	int i;
...
static int dec_digit(int number, int pos)
{
	int term = 1;
	int i;
	for (i = 0; i < pos; ++i) term *= 10;
...
static int inc_time(int time, int pos)
{
	int newtime = time;
